...
router.get(
  "/createcourse",
  ensureAuthenticated,
  indexController.getcreatecourse
);
router.get(
  "/updatecourse/:id",
  ensureAuthenticated,
  indexController.updatecourse
);
...
router.post(
  "/createcourse",
  ensureAuthenticated,
  indexController.postcreatecourse
);
router.post(
  "/updatecourse/:id",
  ensureAuthenticated,
  indexController.addupdatecourse
);
router.post("/profile/:id", ensureAuthenticated, indexController.Changepass);
router.post(
  "/changeprofile",
  ensureAuthenticated,
  indexController.Changeprofile
);
